...
exports.create = async (req, res) => {
  try {
    ...
    res.status(500).json({ mensaje: 'Error al crear la referencia', error });
  }
};
...
exports.findAll = async (req, res) => {
  try {
    ...
    res.status(500).json({ mensaje: 'Error al obtener las referencias', error });
  }
};
...
exports.findOne = async (req, res) => {
  try {
    ...
    res.status(500).json({ mensaje: 'Error al obtener la referencia', error });
  }
};
...
exports.update = async (req, res) => {
  try {
    ...
    res.json({ mensaje: 'Referencia actualizada correctamente', referencia });
  } catch (error) {
    res.status(500).json({ mensaje: 'Error al actualizar la referencia', error });
  }
};
...
exports.delete = async (req, res) => {
  try {
    ...
    res.status(500).json({ mensaje: 'Error al eliminar la referencia', error });
  }
};
